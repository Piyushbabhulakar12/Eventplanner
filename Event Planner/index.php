...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    <a class="navbar-brand logo" href="#">Event</a>
  ...
  <li class="nav-item">
    <a class="nav-link nava_text" href="index.php">Home</a>
  </li>
  <li class="nav-item">
    <a class="nav-link nava_text" href="Log/log.php">Login</a>
  </li>
 <li class="nav-item">
    <a class="nav-link nava_text" href="Log/index.php">Register</a>
  </li>
